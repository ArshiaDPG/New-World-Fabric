...
public class NWPlacedFeatures {
    public static final RegistryEntry<PlacedFeature> FIR_PLACED = PlacedFeatures.register("fir_placed",
            NWConfiguredFeatures.FIR_SPAWN, VegetationPlacedFeatures.modifiers(
                    PlacedFeatures.createCountExtraModifier(3, 0.1f, 5)));

    public static final RegistryEntry<PlacedFeature> GLOW_LICHEN_WOODED_MEADOW = PlacedFeatures.register("glow_lichen_wooded_meadow",
    ...
    public static final RegistryEntry<PlacedFeature> PATCH_BERRY_WOODED_MEADOW = PlacedFeatures.register("patch_berry_wooded_meadow", NWConfiguredFeatures.PATCH_BERRY_BUSH_WOODED_MEADOW, RarityFilterPlacementModifier.of(12), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
}
